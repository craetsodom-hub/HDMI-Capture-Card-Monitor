...
public sealed record AudioMonitorDiagnostics(
    ...
    long PhysicalCapacityDroppedFrames = 0,
    long LatencyTrimmedFrames = 0,
    long RingStarvationEvents = 0,
    long NativeRenderUnderfillEvents = 0,
    long StartupSilenceFrames = 0,
    double CaptureEventIntervalAverageMilliseconds = 0,
    double CaptureEventIntervalP95Milliseconds = 0,
    double CaptureEventIntervalMaximumMilliseconds = 0,
    long CaptureLongGapCount = 0,
    long EmptyCaptureWakeCount = 0,
    IReadOnlyDictionary<int, long>? CapturePacketFrameDistribution = null,
    double RenderEventIntervalAverageMilliseconds = 0,
    double RenderEventIntervalP95Milliseconds = 0,
    double RenderEventIntervalMaximumMilliseconds = 0,
    long RenderLongGapCount = 0,
    uint CurrentRenderPaddingFrames = 0,
    double RenderFramesAvailableAverage = 0,
    int RenderFramesAvailableMaximum = 0,
    long RenderLateWakeCount = 0,
    IReadOnlyDictionary<int, long>? RenderFramesAvailableDistribution = null,
    double? EstimatedClockDriftPpm = null,
    bool RateAdjustmentActive = false,
    long RateAdjustmentActivationMilliseconds = 0,
    double CaptureDeviceFramesPerSecond = 0,
    double RenderConsumptionFramesPerSecond = 0,
    int TotalKnownBufferedFrames = 0)
{
