...
| Buffer and drift policy | 960-frame target, 2,880-frame hard capacity, complete frames only, one-period render writes, fair render/capture servicing, and a non-real-time proportional controller bounded to ±3,000 ppm | Source, deterministic-test, and hardware-run guarded |
...
| Corrected ten-minute muted run | 28,789,536 captured; 28,788,960 rendered; 480 silent; 0 underruns; 0 overruns; 0 dropped; 3 discontinuities; 0 timestamp errors; final queue 576; maximum queue 1,536 frames (32 ms); final correction +400 ppm | Executed successfully; queue stayed bounded and cleanup completed |
