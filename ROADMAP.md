...
| 5. Audio | Optional local WASAPI audio monitoring | Manual capture/output selection, event-driven shared-mode playback, bounded buffering, typed failures, and deterministic cleanup | Draft native-safety correction and honest muted evidence recorded; a nine-underrun endurance burst, audible headphone validation, and physical USB HDMI audio validation remain blocking work |
