...
| 5. Audio | Optional local WASAPI audio monitoring | Manual capture/output selection, event-driven shared-mode playback, bounded buffering, typed failures, and deterministic cleanup | Draft implementation and lossless ten-minute muted laptop evidence recorded; audible headphone and physical USB HDMI audio validation remain blocking release work |
